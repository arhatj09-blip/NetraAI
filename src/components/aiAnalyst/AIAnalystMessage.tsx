...
export const AIAnalystMessage: React.FC<AIAnalystMessageProps> = ({
  ...
  if (isUser) {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] bg-blue-600 text-white px-4 py-3 rounded-2xl rounded-tr-sm shadow-md space-y-1">
          <div className="flex items-center justify-end gap-1.5 text-[10px] uppercase font-bold text-blue-100">
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-[95%] w-full bg-slate-800/80 dark:bg-slate-900/90 p-4 sm:p-5 rounded-2xl rounded-tl-sm border border-slate-700/60 border-l-4 border-l-blue-500 shadow-lg space-y-3.5 backdrop-blur-sm">
        {/* Header */}
            ...
            {message.actionChips.map((chip) => (
              <button
                ...
                className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg
                           bg-slate-700/50 hover:bg-blue-600/20 text-slate-300 hover:text-blue-300
                           border border-slate-600/50 hover:border-blue-500/40 text-[11px] font-semibold
